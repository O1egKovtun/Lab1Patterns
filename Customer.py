...
def main():
    ...
    # Create customers
    bill1 = Bill(100)
    customer1 = Customer(0, "Oleg", 20, operator1, bill1, 100)

    bill2 = Bill(200)
    customer2 = Customer(1, "Olena", 18, operator2, bill2, 200)

    # Customers interact
    customer1.talk(5, customer2)
    customer1.message(8, customer2)
